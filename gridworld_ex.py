...
if __name__ == "__main__":
    ...
    stoPar_perturbed= [0.1, 0.3] # [0.1, 0.12, 0.15, 0.2]
    ...
    trigger = FSCTriggerGW(gridworld, k)
    ...
    backdoorSolver_Adam.switchingGradient_no_marginalization(gridworld, epsilon,adversary_reward, trigger, augmdp, k, './gridworld_ex', episodes_num)
    print("complete ...")